...
#### Winner Logic
I know that this is a pretty common exercise, and it is even on React's official documentation page as a tutorial. Normally, I like using resources like this; however, I wanted to create my own solution. But, if this was a work scenario, I would happliy learn from and use someone elses code if it had a better Big O rank. 
